...
const { getTemplateToEdit,getTemplates, getTemplateById,getWapByUserId, getWaps, getWapById, addWap, updateWap, removeWap, addWapMsg, removeWapMsg } = require('./wap.controller')
